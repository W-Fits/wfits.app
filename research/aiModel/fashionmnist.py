...
#Added print statements for knowing what parameters are being used for later model reconstruction
print(f"arch={args.arch}")
print(f"depth={args.depth}")
print(f"widen_factor={args.widen_factor}")
print(f"dropRate={args.drop}")
